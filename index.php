...
switch ($_SESSION['Type']) {
    ...
    default:
        $router->get("/", "App\Controller\ArticleController@index");

        $router->get("/articles", "App\Controller\ArticleController@showArticles");

        $router->get("/add", "App\Controller\ArticleController@addArticle");
        ...
        $router->post("/modify/:id", "App\Controller\ArticleController@modifyArticle");
